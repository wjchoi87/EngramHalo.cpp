...
// ---------------------------------------------------------------------------------------------
    ...
    // Q4_0_ROCMFP4 uses Q3_K tile geometry (dual UE4M3 half-block scales -> 16 floats / 32 cols),
    // Q4_0_ROCMFP4_FAST uses Q8_0 tile geometry (single scale -> 8 floats / 32 cols).
